...
export default function Navbar({ cart, setCart }) {
  return (
    <div>
      ...
      <div className=" p-2 flex  shadow-xl mt-2 bg-indigo-950">
        <div className="w-[20%]">
          <img
        ...
        <div className="w-[40%] flex">
          ...
          <Link to="/login">
            ...
            {/* <button className=" bg-blue-950 py-1 px-5 text-white text-lg font-bold rounded-lg  ml-10 m-2"> */}{" "}
            {/* </button> */}
          </Link>
          ...
          <button
            className=" bg-blue-950 py-1 px-5 text-white text-lg font-bold rounded-lg  ml-10 m-2"
            type="button"
          >
            Help
          </button>
